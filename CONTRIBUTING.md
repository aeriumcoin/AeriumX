Contributing to AeriumX Core
============================

The AeriumX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AeriumX Core project, and is not to be
confused with overall AeriumX Network Protocol consensus changes.

Whether a pull request is merged into AeriumX Core rests with the project merge
...
Patches that change AeriumX consensus rules are considerably more involved than
...
Where a patch set proposes to change the AeriumX consensus, it must have been
...
The project leader is the release manager for each AeriumX Core release.
