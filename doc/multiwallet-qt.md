...
In order to support loading of multiple wallets in aeriumx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aeriumx.cpp.
...
Changes to aeriumx.cpp
----------------------
aeriumx.cpp is the entry point into aeriumx-qt, and as such, will require some minor modifications to provide hooks for
