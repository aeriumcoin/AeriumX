...
This mechanism has been integrated into Bitcore-Node-AeriumX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/AeriumX-Project/insight-api-aeriumx#web-socket-api](https://github.com/AeriumX-Project/insight-api-aeriumx#web-socket-api) 
* API: [https://github.com/AeriumX-Project/insight-api-aeriumx#swifttx-transactions](https://github.com/AeriumX-Project/insight-api-aeriumx#swifttx-transactions) 
...
By default, the AeriumX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the AeriumX Core daemon:
