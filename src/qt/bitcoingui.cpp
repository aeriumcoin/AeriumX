                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AeriumX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AeriumX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aeriumx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AeriumX Core"), this);
    aboutAction->setStatusTip(tr("Show information about AeriumX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AeriumX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AeriumX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AeriumX addresses"));
    ...
    openAction->setStatusTip(tr("Open a AeriumX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AeriumX Core help message to get a list with possible AeriumX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AeriumX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AeriumX network", "", count));
}
...
{
    QString strTitle = tr("AeriumX Core"); // default title
