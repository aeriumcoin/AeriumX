...
/* AeriumX GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AeriumX"
#define QAPP_ORG_DOMAIN "aeriumx.org"
#define QAPP_APP_NAME_DEFAULT "AeriumX-Qt"
#define QAPP_APP_NAME_TESTNET "AeriumX-Qt-testnet"
