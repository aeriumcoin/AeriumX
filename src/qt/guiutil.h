...
/** Utility functions used by the AeriumX Qt UI.
 */
namespace GUIUtil
{
...
// Render AeriumX addresses in monospace font
...
// Parse "aeriumx:" URI into recipient object, return true on successful parsing
