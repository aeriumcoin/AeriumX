 ...
 */
    ...
    typeWidget->addItem(tr("Received AEX from zAEX"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAEX"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAEX));
